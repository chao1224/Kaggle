...
public class ID3 {
	...
	public static void main(String[] args) {
		...
		dataSet.add(new Item(new String[] { "1", "1", "yes" }));
		dataSet.add(new Item(new String[] { "1", "1", "yes" }));
		dataSet.add(new Item(new String[] { "1", "0", "no" }));
		dataSet.add(new Item(new String[] { "0", "1", "no" }));
		dataSet.add(new Item(new String[] { "0", "1", "no" }));

		System.out.println(calcShannonEntropy(dataSet));

		// LinkedList<String> labels = new LinkedList<String>();
		// labels.add("no surfacing");
		// labels.add("flipper");
		//
		// DecisionTreeNode root = createTree(dataSet, labels);
		// print(root);
		//
		// System.out.println();
		...
		// testVector.add("1");
		//
		// System.out.println(classify(root, labels, testVector));
